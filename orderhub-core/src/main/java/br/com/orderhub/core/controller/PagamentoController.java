...
public class PagamentoController {
    ...
    public PagamentoDTO gerarOrdemPagamento(CriarPagamentoDTO criarPagamentoDTO) throws Exception {
        return PagamentoPresenter.ToDTO(gerarOrdemPagamento.run(criarPagamentoDTO));
    }
}
